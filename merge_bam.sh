...
# Merge mice WT
samtools merge \
  "mice_WT_KU_r1_mm10_merged.bam" \
  "mice_WT_KU_r1_L1_mm10_final.bam" \
  "mice_WT_KU_r1_L1_mm10_final.bam" \
& \
samtools merge \
  "mice_WT_KU_r2_mm10_merged.bam" \
  "mice_WT_KU_r2_L1_mm10_final.bam" \
  "mice_WT_KU_r2_L1_mm10_final.bam" \
& \
samtools merge \
  "mice_WT_KU_r3_mm10_merged.bam" \
  "mice_WT_KU_r3_L1_mm10_final.bam" \
  "mice_WT_KU_r3_L1_mm10_final.bam" \
& \
samtools merge \
  "mice_WT_nD_r1_mm10_merged.bam" \
  "mice_WT_nD_r1_L1_mm10_final.bam" \
  "mice_WT_nD_r1_L1_mm10_final.bam" \
& \
samtools merge \
  "mice_WT_nD_r2_mm10_merged.bam" \
  "mice_WT_nD_r2_L1_mm10_final.bam" \
  "mice_WT_nD_r2_L1_mm10_final.bam" \
& \
samtools merge \
  "mice_WT_nD_r3_mm10_merged.bam" \
  "mice_WT_nD_r3_L1_mm10_final.bam" \
  "mice_WT_nD_r3_L1_mm10_final.bam"
samtools index "mice_WT_KU_r1_mm10_merged.bam" & \
samtools index "mice_WT_KU_r2_mm10_merged.bam" & \
samtools index "mice_WT_KU_r3_mm10_merged.bam" & \
samtools index "mice_WT_nD_r1_mm10_merged.bam" & \
samtools index "mice_WT_nD_r2_mm10_merged.bam" & \
samtools index "mice_WT_nD_r3_mm10_merged.bam"
