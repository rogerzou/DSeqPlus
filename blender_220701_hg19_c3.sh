...
mkdir -p /mnt/z/rzou4/NGS_data/4_damage/Dseq+/Tcell_Cas9_g_KU_r1_c3
mkdir -p /mnt/z/rzou4/NGS_data/4_damage/Dseq+/Tcell_Cas9_g_nD_r1_c3
mkdir -p /mnt/z/rzou4/NGS_data/4_damage/Dseq+/Tcell_Cas9_ng_KU_r1_c3
mkdir -p /mnt/z/rzou4/NGS_data/4_damage/Dseq+/Tcell_Cas9_ng_nD_r1_c3
mkdir -p /mnt/z/rzou4/NGS_data/4_damage/Dseq+/Tcell_Cpf1_g_KU_r1_c3
mkdir -p /mnt/z/rzou4/NGS_data/4_damage/Dseq+/Tcell_Cpf1_g_nD_r1_c3
mkdir -p /mnt/z/rzou4/NGS_data/4_damage/Dseq+/Tcell_Cpf1_ng_KU_r1_c3
mkdir -p /mnt/z/rzou4/NGS_data/4_damage/Dseq+/Tcell_Cpf1_ng_nD_r1_c3
...
mkdir -p /mnt/z/rzou4/NGS_data/4_damage/Dseq+/public_K562_Cpf1_08h
mkdir -p /mnt/z/rzou4/NGS_data/4_damage/Dseq+/public_K562_Cpf1_24h
...
sh run_blender.sh $hg19_bowtie2 $public_K562_Cpf1_08h $public_K562_Cpf1_bfp $DNMT1_gRNA \
   /mnt/z/rzou4/NGS_data/4_damage/Dseq+/public_K562_Cpf1_08h "-c=3 -p=TTT -n=Cpf1" \
& \
# public K562 Cpf1 DMNT3 24bp gRNA 24h
sh run_blender.sh $hg19_bowtie2 $public_K562_Cpf1_24h $public_K562_Cpf1_bfp $DNMT1_gRNA \
   /mnt/z/rzou4/NGS_data/4_damage/Dseq+/public_K562_Cpf1_24h "-c=3 -p=TTT -n=Cpf1"
